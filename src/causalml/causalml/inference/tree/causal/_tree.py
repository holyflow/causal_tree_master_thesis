...
class BaseCausalDecisionTree(BaseDecisionTree):
    ...
    def __init__(self, min_treated_leaf: int, min_control_leaf: int, min_group_samples: int, *args, **kwargs):
    ...
    def fit(
        ...
        if isinstance(criterion, str):
            ...
            criterion.min_treated_leaf = self.min_treated_leaf
            criterion.min_control_leaf = self.min_control_leaf
        else:
