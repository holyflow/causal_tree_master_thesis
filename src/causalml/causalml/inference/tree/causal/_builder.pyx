...
cdef class DepthFirstCausalTreeBuilder(TreeBuilder):
    ...
    cdef intp_t min_treated_leaf
    cdef intp_t min_control_leaf
    ...
    def __cinit__(self, Splitter splitter, intp_t min_samples_split,
                  ...
                  intp_t min_treated_leaf,
                  intp_t min_control_leaf,):
        ...
        with nogil:
            ...
            while not builder_stack.empty():
                ...
                is_leaf = (depth >= max_depth or
                           ...
                           tr_count_mean < self.min_treated_leaf * 2 or
                           ct_count < self.min_control_leaf * 2 or
